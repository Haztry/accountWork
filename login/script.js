  ...
  setupSocialButtons() {
    this.socialButtons.forEach((button) => {
      button.addEventListener("click", (e) => {
        const provider = button.classList.contains("google-material")
          ? "Google"
          : "Facebook";
    ...
    [this.emailInput, this.passwordInput].forEach((input) => {
      input.addEventListener("focus", (e) => {
        const rippleContainer =
          input.parentNode.querySelector(".ripple-container");
  ...
  showMaterialSuccess() {
    ...
    setTimeout(() => {
      ...
      successIcon.style.animation =
        "materialSuccessScale 0.5s cubic-bezier(0.25, 0.8, 0.25, 1)";
    }, 300);
